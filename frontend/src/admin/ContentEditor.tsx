...
const SECTION_LABELS: Record<string, { label: string; hint: string }> = {
  ...
  intro:      { label: "Anasayfa > Intro Bandı (Üst)",                hint: "Sayfa en üstündeki kurumsal açılış bandı" },
  hero:       { label: "Anasayfa > Hero (Bölüm 1)",                   hint: "Açılış kartı: üst etiket, büyük başlık ve görsel kompozisyon" },
  taste:      { label: "Anasayfa > Anı Tadın (Bölüm 2)",              hint: "Hero altındaki sakin karşılama bloğu" },
  botanical:  { label: "Anasayfa > Botanik Demlemeler (Bölüm 3)",     hint: "Tam genişlik koyu arka planlı botanik bölümü" },
  plant:      { label: "Anasayfa > Bitkisel (Bölüm 4)",               hint: "Vegan & bitkisel seçenekler bloğu" },
  roasted:    { label: "Anasayfa > Yeni Kavruldu (Bölüm 5)",          hint: "Kavurma vurgusu — çekirdek kareleri ve makine fotoğrafı" },
  barista:    { label: "Anasayfa > Barista Zanaatı (Bölüm 6)",        hint: "Barista portresi etrafındaki başlık, etiket ve buton metinleri" },
  slowdown:   { label: "Anasayfa > Yavaşlayın (Bölüm 7)",             hint: "Sayfa ortasındaki dinlenme/atmosfer bloğu" },
  selection:  { label: "Anasayfa > Kahve Seçkimiz (Bölüm 8)",         hint: "Üç çekirdek kartlı, dönen halka bölümü" },
  menu:       { label: "Anasayfa > Menü Önizlemesi (Bölüm 9)",        hint: "Anasayfadaki menü vurgusu — başlık, etiket ve 'Tümünü gör' butonu" },
  visit:      { label: "Anasayfa > Ziyaret (Bölüm 10)",               hint: "Adres, çalışma saatleri, telefon ve e-posta bloğu" },
  newsletter: { label: "Anasayfa > Bülten (Bölüm 11)",                hint: "Newsletter formu ve sosyal medya etiketleri" },
  footer:     { label: "Anasayfa > Footer (Bölüm 12)",                hint: "Hızlı bağlantılar, küçük not formu ve telif satırı" },
  // Media groups
  "media-intro":     { label: "Görsel · Anasayfa > Intro Bandı",       hint: "Sayfa en üstündeki tam ekran soluk arka plan görseli" },
  "media-hero":      { label: "Görsel · Anasayfa > Hero (Bölüm 1)",    hint: "Sayfanın açılışındaki üç katmanlı kart kompozisyonu" },
  "media-taste":     { label: "Görsel · Anasayfa > Anı Tadın (Bölüm 2)", hint: "Üç sütunlu sakin koleksiyon" },
  "media-plant":     { label: "Görsel · Anasayfa > Bitkisel (Bölüm 4)", hint: "Vegan & bitkisel bölüm görselleri" },
  "media-roasted":   { label: "Görsel · Anasayfa > Yeni Kavruldu (Bölüm 5)", hint: "Çekirdek mozaik, kavurma makinesi ve fincan" },
  "media-barista":   { label: "Görsel · Anasayfa > Barista (Bölüm 6)", hint: "Barista portresi, eller ve iş başında kart" },
  "media-slowdown":  { label: "Görsel · Anasayfa > Yavaşlayın (Bölüm 7)", hint: "Bitki duvarı ve mekân iç görselleri" },
  "media-selection": { label: "Görsel · Anasayfa > Seçki (Bölüm 8)",   hint: "Üçlü çekirdek kart grubu" },
  "media-visit":     { label: "Görsel · Anasayfa > Ziyaret (Bölüm 10)", hint: "Mekân/atölye fotoğrafı" },
};
...
const EXACT_LABELS: Record<string, string> = {
  ...
  "footer.copyright":        "Anasayfa > Footer (Bölüm 12) > Telif Satırı",
  "footer.note_title":       "Anasayfa > Footer (Bölüm 12) > Not Formu Başlığı",
  "footer.note_placeholder": "Anasayfa > Footer (Bölüm 12) > Not Form Placeholder'ı",
  "footer.note_button":      "Anasayfa > Footer (Bölüm 12) > Gönder Butonu",
  "footer.link_menu":        "Anasayfa > Footer (Bölüm 12) > Menü Linki",
  "footer.link_story":       "Anasayfa > Footer (Bölüm 12) > Hikâye Linki",
  "footer.social_ig":        "Anasayfa > Footer (Bölüm 12) > Instagram Etiketi",
  "footer.social_ig_url":    "Anasayfa > Footer (Bölüm 12) > Instagram URL",
  "footer.social_fb":        "Anasayfa > Footer (Bölüm 12) > Facebook Etiketi",
  "footer.social_fb_url":    "Anasayfa > Footer (Bölüm 12) > Facebook URL",
  "footer.social_tt":        "Anasayfa > Footer (Bölüm 12) > TikTok Etiketi",
  "footer.social_tt_url":    "Anasayfa > Footer (Bölüm 12) > TikTok URL",
  "visit.address":           "Anasayfa > Ziyaret (Bölüm 10) > Adres",
  "visit.hours":             "Anasayfa > Ziyaret (Bölüm 10) > Çalışma Saatleri",
  "visit.phone":             "Anasayfa > Ziyaret (Bölüm 10) > Telefon",
  "visit.email":             "Anasayfa > Ziyaret (Bölüm 10) > E-posta",
  "newsletter.success":      "Anasayfa > Bülten (Bölüm 11) > Form Başarı Mesajı",
};
