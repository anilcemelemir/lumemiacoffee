...
const DEFAULT_CONTENT_ITEMS: ContentItem[] = [
  ...
  { key: "intro.kicker", value: "Lume Mia Coffee", group: "intro", label: "Intro üst etiketi", updated_at: "" },
  { key: "intro.title", value: "Kurumsal kahve deneyimi", group: "intro", label: "Intro ana başlık", updated_at: "" },
  { key: "intro.body", value: "Lume Mia, seçili çekirdekleri, sakin servis dilini ve botanik atmosferini aynı standartta buluşturan çağdaş bir kahve evidir. Her fincan; izlenebilir tedarik, dikkatli kavurma ve tutarlı misafir deneyimi üzerine kurulur.", group: "intro", label: "Intro açıklama metni", updated_at: "" },
  { key: "intro.metric_1", value: "Seçili tedarik", group: "intro", label: "Intro kısa vurgu 1", updated_at: "" },
  { key: "intro.metric_2", value: "Günlük hazırlık", group: "intro", label: "Intro kısa vurgu 2", updated_at: "" },
  { key: "intro.metric_3", value: "Net servis standardı", group: "intro", label: "Intro kısa vurgu 3", updated_at: "" },
  { key: "intro.cta", value: "Hikâyemizi incele", group: "intro", label: "Intro buton metni", updated_at: "" },
  { key: "media.intro.banner", value: "/images/visit_interior.jpg", group: "media-intro", label: "Kurumsal açılış bandı arka plan görseli", updated_at: "" },
  { key: "menu.cta.eyebrow", value: "MENÜMÜZ", group: "menu", label: "Anasayfa menü üst etiketi", updated_at: "" },
  { key: "menu.cta.title", value: "TÜM TATLAR\nBİR ARADA", group: "menu", label: "Anasayfa menü başlığı", updated_at: "" },
  { key: "menu.cta.body", value: "Mevsime göre değişen kahvelerimiz, bitkisel demlerimiz ve atıştırmalıklarımız için menünün tamamına göz atın.", group: "menu", label: "Anasayfa menü açıklaması", updated_at: "" },
  { key: "menu.cta.button", value: "Menüyü Gör", group: "menu", label: "Anasayfa menü butonu", updated_at: "" },
...
const SECTION_LABELS: Record<string, { label: string; hint: string }> = {
  brand:      { label: "Tüm Sayfalar > Başlık & Footer",              hint: "Marka adı, slogan ve logo filigranı — başlık ve footer'da görünür" },
  story:      { label: "Ayrı Sayfa > /hikayemiz",                      hint: "Ayrı /hikayemiz sayfasının tüm metin ve görsel alanları" },
  nav:        { label: "Tüm Sayfalar > Üst Menü Bağlantıları",        hint: "Sağ üstteki menü bağlantı etiketleri" },
  intro:      { label: "Anasayfa > Sayfa Başı — Intro Bandı",         hint: "Sayfa en üstündeki kurumsal açılış bandı (1. bölümden önce)" },
  hero:       { label: "Anasayfa > 1. Bölüm — Açılış Ekranı (Sayfa Başı)", hint: "Açılış kartı: üst etiket, büyük başlık ve görsel kompozisyon" },
  taste:      { label: "Anasayfa > 2. Bölüm — Üst Kısım",             hint: "Hero altındaki sakin karşılama bloğu" },
  botanical:  { label: "Anasayfa > 3. Bölüm — Üst Kısım",             hint: "Tam genişlik koyu arka planlı bölüm" },
  plant:      { label: "Anasayfa > 4. Bölüm — Üst Kısım",             hint: "Vegan & bitkisel seçenekler bloğu" },
  roasted:    { label: "Anasayfa > 5. Bölüm — Orta Kısım",            hint: "Kavurma vurgusu — çekirdek kareleri ve makine fotoğrafı" },
  barista:    { label: "Anasayfa > 6. Bölüm — Orta Kısım",            hint: "Barista portresi etrafındaki başlık, etiket ve buton metinleri" },
  slowdown:   { label: "Anasayfa > 7. Bölüm — Orta Kısım",            hint: "Sayfa ortasındaki dinlenme/atmosfer bloğu" },
  selection:  { label: "Anasayfa > 8. Bölüm — Orta Kısım",            hint: "Üç çekirdek kartlı, dönen halka bölümü" },
  menu:       { label: "Menü Sayfası & Anasayfa > Menü Çağrı Bölümü", hint: "Menü sayfası başlığı ve anasayfadaki 'Menüyü Gör' çağrı bloğu" },
  ...
  "media-taste":     { label: "Görsel · Anasayfa > 2. Bölüm — Üst Kısım", hint: "Üç sütunlu sakin koleksiyon" },
  "media-plant":     { label: "Görsel · Anasayfa > 4. Bölüm — Üst Kısım", hint: "Vegan & bitkisel bölüm görselleri" },
  "media-roasted":   { label: "Görsel · Anasayfa > 5. Bölüm — Orta Kısım", hint: "Çekirdek mozaik, kavurma makinesi ve fincan" },
  "media-barista":   { label: "Görsel · Anasayfa > 6. Bölüm — Orta Kısım", hint: "Barista portresi, eller ve iş başında kart" },
  "media-slowdown":  { label: "Görsel · Anasayfa > 7. Bölüm — Orta Kısım", hint: "Bitki duvarı ve mekân iç görselleri" },
  "media-selection": { label: "Görsel · Anasayfa > 8. Bölüm — Orta Kısım", hint: "Üçlü çekirdek kart grubu" },
  "media-visit":     { label: "Görsel · Anasayfa > 10. Bölüm — Alt Kısım", hint: "Mekân/atölye fotoğrafı" },
};
...
const EXACT_LABELS: Record<string, string> = {
  "brand.name":              "Tüm Sayfalar > Başlık & Footer > Marka Adı",
  "brand.tagline":           "Tüm Sayfalar > Başlık & Footer > Marka Sloganı",
  "brand.watermark":         "Tüm Sayfalar > Arka Plan > Logo Filigranı",
  "intro.kicker":            "Anasayfa > Intro Bandı > Üst Etiket",
  "intro.title":             "Anasayfa > Intro Bandı > Ana Başlık",
  "intro.body":              "Anasayfa > Intro Bandı > Açıklama",
  "intro.metric_1":          "Anasayfa > Intro Bandı > Kısa Vurgu 1",
  "intro.metric_2":          "Anasayfa > Intro Bandı > Kısa Vurgu 2",
  "intro.metric_3":          "Anasayfa > Intro Bandı > Kısa Vurgu 3",
  "intro.cta":               "Anasayfa > Intro Bandı > Buton Metni",
  "story.image":             "Hikâyemiz Sayfası > Giriş > Sağ Kart Görseli",
  "story.body_html":         "Hikâyemiz Sayfası > İçerik > Ana Metin Bloğu (HTML)",
  "story.eyebrow":           "Hikâyemiz Sayfası > Giriş > Üst Başlık (Kırmızı Yazı)",
  "story.title":             "Hikâyemiz Sayfası > Giriş > Sayfa Başlığı",
  "story.intro":             "Hikâyemiz Sayfası > Giriş > Spot Paragraf",
  "story.cta_label":         "Hikâyemiz Sayfası > Alt > Buton Metni (CTA)",
  "footer.copyright":        "Anasayfa > 12. Bölüm (Footer) > Telif Satırı",
  "footer.note_title":       "Anasayfa > 12. Bölüm (Footer) > Not Formu Başlığı",
  "footer.note_placeholder": "Anasayfa > 12. Bölüm (Footer) > Not Form Placeholder'ı",
  "footer.note_button":      "Anasayfa > 12. Bölüm (Footer) > Gönder Butonu",
  "footer.consent":          "Anasayfa > 12. Bölüm (Footer) > Onay Kutusu Metni",
  "footer.link_menu":        "Anasayfa > 12. Bölüm (Footer) > Menü Linki",
  "footer.link_story":       "Anasayfa > 12. Bölüm (Footer) > Hikâye Linki",
  "footer.social_ig":        "Anasayfa > 12. Bölüm (Footer) > Instagram Etiketi",
  "footer.social_ig_url":    "Anasayfa > 12. Bölüm (Footer) > Instagram URL",
  "footer.social_fb":        "Anasayfa > 12. Bölüm (Footer) > Facebook Etiketi",
  "footer.social_fb_url":    "Anasayfa > 12. Bölüm (Footer) > Facebook URL",
  "footer.social_tt":        "Anasayfa > 12. Bölüm (Footer) > TikTok Etiketi",
  "footer.social_tt_url":    "Anasayfa > 12. Bölüm (Footer) > TikTok URL",
  "visit.address":           "Anasayfa > 10. Bölüm (Ziyaret) > Adres",
  "visit.hours":             "Anasayfa > 10. Bölüm (Ziyaret) > Çalışma Saatleri",
  "visit.phone":             "Anasayfa > 10. Bölüm (Ziyaret) > Telefon",
  "visit.email":             "Anasayfa > 10. Bölüm (Ziyaret) > E-posta",
  "newsletter.success":      "Anasayfa > 11. Bölüm (Bülten) > Form Başarı Mesajı",
  "menu.title":              "Menü Sayfası > Ana Başlık",
  "menu.subtitle":           "Menü Sayfası > Alt Açıklama",
  "menu.cta.eyebrow":        "Anasayfa > Menü Çağrı Bölümü > Üst Etiket",
  "menu.cta.title":          "Anasayfa > Menü Çağrı Bölümü > Ana Başlık",
  "menu.cta.body":           "Anasayfa > Menü Çağrı Bölümü > Açıklama",
  "menu.cta.button":         "Anasayfa > Menü Çağrı Bölümü > Buton Metni",
};
